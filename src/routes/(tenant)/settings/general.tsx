      ...
      <div className="mx-auto max-w-4xl space-y-6">
        ...
        <Card>
          ...
          <CardContent className="p-6">
            <dl className="grid gap-x-8 gap-y-5 sm:grid-cols-2">
              ...
              <div>
                <dt className="font-medium text-warm-gray text-xs">
                  Accent color
                </dt>
                <dd className="mt-1.5 flex items-center gap-2 text-ink-black text-sm">
                  <span
        ...
        <Card>
          ...
          <CardContent className="p-6">
            <dl className="grid gap-x-8 gap-y-5 sm:grid-cols-2">
              <div>
                <dt className="font-medium text-warm-gray text-xs">Status</dt>
                <dd className="mt-1.5">
...
function Detail({ label, value }: { label: string; value: ReactNode }) {
  return (
    <div>
      <dt className="font-medium text-warm-gray text-xs">{label}</dt>
      <dd className="mt-1 break-words text-ink-black text-sm">
        {value ?? "—"}
      </dd>
    </div>
  );
